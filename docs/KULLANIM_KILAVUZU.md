...
Sol raydan **Araçlar** panelini açın; 15 araç ikon olarak listelenir. Bir ikona tıklamak o aracın panelini açar; aynı ikona tekrar tıklamak paneli kapatır. Aynı anda yalnızca bir araç aktif olabilir.
...
| **Veri içe aktar** *(yalnızca personel)* | Bir GeoJSON dosyası seçip hedef tabloyu (imar lekesi, proje, zemin etüt vb.) belirleyerek toplu veri yükleyin. Sonuçta kaç kaydın yazıldığı/atlandığı özetlenir. |
...
| İmar planı, arazi/adres, yol rayiç, zemin etüt katmanları | ❌ | ✅ | ✅ |
...
4. Dört bölüm kartı ayrıntıları gösterir:
...
5. **"Haritada aç"** düğmesi, sizi seçili mahalleyi merkezleyen ana harita görünümüne götürür.
6. **"Karneyi PDF indir"** düğmesi, tüm bu bilgileri tek sayfalık bir PDF olarak indirir.
